  ...
  return dashData && (
    <div className='m-5'>
       <div className='flex flex-wrap gap-3'>
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 cursor-pointer border border-gray-100 hover:scale-105 transition-all'>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 cursor-pointer border border-gray-100 hover:scale-105 transition-all'>
          ...
          <div>
            ...
            <p className="text-gray-400" >Appointmnets</p>
          </div>
        </div>
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 cursor-pointer border border-gray-100 hover:scale-105 transition-all'>
        ...
        <div className='pt-4 border border-t-0'>
          {
            dashData.latestAppointments?.map((item,index)=>(
              <div key={index} className='flex items-center py-3 px-6 gap-3 hover:bg-gray-100'>
