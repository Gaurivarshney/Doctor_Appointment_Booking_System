...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col text-gray-900 gap-4 items-center mb-10 md:mx-10'>
      <h1 className='font-semibold text-md md:text-xl lg:text-4xl'>Top Doctors</h1>
      <p className='sm:w-1/3 text-center text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque, veritatis!</p>
